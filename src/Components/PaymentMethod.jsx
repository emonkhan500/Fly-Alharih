...
const PaymentMethod = () => {
  return (
    <div className="font mb-14">
      ...
      {/* method  */}
      <div className="flex flex-col md:flex-row gap-10 px-10 lg:px-52 mt-8">
        <div>
            <h1 className="text-lg font-semibold mb-2">Bangladeshi Taka (BDT) </h1>
            <div>
                <img src={payment} alt="" />
        ...
        <div>
            <h1 className="text-lg font-semibold mb-2">United States Dollar (USD) </h1>
            <div>
                <img src={payment} alt="" />
